...
<section class="content-header text-center">
  <h1>
  <i class="fas fa-user-edit"></i>&nbsp&nbsp&nbspEditar Ponente
  </h1>
</section>
            ...
            while($row = $result->fetch(PDO::FETCH_ASSOC)) {
              ...
              echo '
                <tr>
                  ...
                  <td>
                    <button class="btn btn-primary button-edit" id="'.$id_speaker.'" data-toggle="modal" data-target="#modal-edit-speaker">
...
<!-- Modal -->
<div class="modal fade" id="modal-edit-speaker" tabindex="-1" role="dialog" aria-labelledby="label">
        ...
        <form action="../../web_services/speakers/newspeakerService.php" method="post">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input id="input-id_speaker" type="text" class="form-control" disabled="disabled" required="required">
            </div>
          </div>
          <div class="form-group">
...
<script src="../js/modal-edit-speaker.js"></script>