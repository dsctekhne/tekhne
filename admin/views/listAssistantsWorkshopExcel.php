...
<section class="content-header text-center">
  <h1>
    <i class="fas fa-file-excel"></i>&nbsp&nbsp&nbspGenerar excel alumnos registrados
  </h1>
</section>
            ...
            while($row = $result->fetch(PDO::FETCH_ASSOC)) {
              ...
              echo '
                <tr>
                  ...
                  echo '
                  <td>
                    <form target="_blank" action="excelWorkshop.php" method="post">
                      <button type="submit" class="btn btn-success" name="id_workshop" value="'.$id_workshop.'">
